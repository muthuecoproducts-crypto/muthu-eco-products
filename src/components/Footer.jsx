    ...
    <footer className="bg-gray-100 py-12">
      <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                <a href="/products" className="block text-gray-600 hover:text-primary transition-colors">Products</a>
        ...
        <div className="border-t border-gray-300 mt-8 pt-8 text-center">
          <p className="text-gray-600">© 2024 Muthu Eco Products. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
