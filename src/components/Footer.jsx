        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div>
            <div className="mb-6 sm:mb-8">
              <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 text-white">Find Us</h2>
              <p className="text-gray-300 text-base sm:text-lg">
                Visit our store for fresh organic products!
              </p>
            </div>
            <div className="bg-gray-200 rounded-lg overflow-hidden h-48 sm:h-56 md:h-64">
              <iframe
          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="text-xl sm:text-2xl font-bold text-primary mb-4 sm:mb-6">Muthu Eco Products</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-3 sm:gap-4">
                  <a href="#" className="bg-gray-700 p-2 sm:p-3 rounded-full text-gray-300 hover:text-blue-600 hover:bg-gray-600 transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                  </a>
                  <a href="#" className="bg-gray-700 p-2 sm:p-3 rounded-full text-gray-300 hover:text-pink-600 hover:bg-gray-600 transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="#" className="bg-gray-700 p-2 sm:p-3 rounded-full text-gray-300 hover:text-red-600 hover:bg-gray-600 transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                  </a>
                  <a href="#" className="bg-gray-700 p-2 sm:p-3 rounded-full text-gray-300 hover:text-red-500 hover:bg-gray-600 transition-all duration-300 hover:scale-110">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
